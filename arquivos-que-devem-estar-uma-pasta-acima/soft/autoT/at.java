...
public class at {
    ...
    public static String ok[] = {
	  ...
	  "ok-ger21.kra", "testa se o compilador gera código correto se run não é o primeiro método da classe", "0",
	  ...
	  "ok-sem19.kra", "testa operações usando variáveis estáticas", "0",
	  "ok-sem20.kra", "testa métodos finais", "0",
    ...
    public static String er[] = {
      ...
      "er-sem63.kra", "chamada incorreta a método estático", "15",
      "er-sem64.kra", "chamada incorreta a método estático", "15",
      "er-sem65.kra", "chamada incorreta a método estático", "12",
      "er-sem66.kra", "chamada a método não existente", "12",
      "er-sem67.kra", "chamada a método não existente", "15",
      "er-sem68.kra", "chamada a método não existente", "15",
      "er-sem69.kra", "chamada incorreta a método estático", "15",
      ...
      "er-sem77.kra", "Método run ausent", "13",
      "er-sem78.kra", "classe Program ausente", "13",
      "er-sem79.kra", "Método run com parâmetros", "10",
      "er-sem80.kra", "Método run deve retornar 'void'", "10",
      "er-sem81.kra", "Método run deve ser publico", "10",
      "er-sem82.kra", "Método run nao pode ser estatico", "10",
      "er-sem83.kra", "Classe final sendo herdada", "12",
	  "er-sem84.kra", "Método final sendo redeclarado", "14",
      "er-sem85.kra", "Método final em classe final", "8",
    ...
    public static void main(String []args) {
       ...
       out.println();
       out.println("Foram considerados 'especiais' três arquivos ok's e ");
       out.println("nove er's, cujas conferências são mais difíceis de se fazer.");
       out.println("Estes arquivos são chamados 'critical ok' e 'critical er'.");
